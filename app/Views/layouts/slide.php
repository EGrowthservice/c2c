          ...
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                Xin chào bạn</h6>
              <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Khám phá các sản phẩm</h2>
              <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Hấp dẫn</h2>
              <a href="/products"
                class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Xem ngay
                </a>
            </div>
          </div>
        </div>
