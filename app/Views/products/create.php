...
<main class="pt-90 ">
    ...
    <section class="my-account container">
        ...
        <h1 class="mb-5">Đăng sản phẩm</h1>
        ...
        <div class="row">
            ...
            <!-- Nội dung chính -->
            <div class="col-lg-9">
                <form method="POST" action="/products/create" enctype="multipart/form-data" id="createProductForm">
                    <input type="hidden" name="_token" value="<?= htmlspecialchars(Session::get('csrf_token')) ?>">
                    <div class="mb-3">
                        <label for="title" class="form-label">Tiêu đề <span class="text-danger">*</span></label>
                        <input type="text" name="title" id="title" class="form-control" placeholder="Nhập tiêu đề sản phẩm" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="5" placeholder="Mô tả chi tiết sản phẩm" required></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="price" class="form-label">Giá (VND) <span class="text-danger">*</span></label>
                        <input type="number" name="price" id="price" class="form-control" step="1000" min="0" placeholder="Nhập giá sản phẩm" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary" title="Đăng sản phẩm">
                        <i class="bi bi-upload"></i> Đăng sản phẩm
                    </button>
                </form>
            </div>
        </div>
